  ...
  const plans = [
    {
      name: "Silver",
      applications: 20,
      inclusions: "Auto-apply + tracking",
      priceCommitment: "$29.99",
      priceMonthToMonth: "$59.99",
    ...
    },
    {
      name: "Gold",
      applications: 30,
      inclusions: "Silver + resume tailoring",
      priceCommitment: "$49.99",
      priceMonthToMonth: "$79.99",
      buttonText: "Get Started",
      tag: "Most Popular",
      features: [
        "30 applications per month",
        "Resume tailoring per application",
        "Auto-apply and tracking",
      ],
    },
    {
      name: "Platinum",
      applications: 50,
      inclusions: "Gold + interview help",
      priceCommitment: "$79.99",
      priceMonthToMonth: "$99.99",
      buttonText: "Get Started",
      features: [
    ...
    },
    {
      ...
      inclusions: "Applications + resume + interview help",
      priceCommitment: "$1,200 (one-time)",
      priceMonthToMonth: "—",
      buttonText: "Contact Us",
      features: [
        "Unlimited applications during campaign window",

        ...
        <div className="w-full">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-4 bg-gradient-to-r from-orange-500 to-red-600 text-white font-bold text-lg rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? (
            ...
            <p className="mt-6 text-center text-sm text-gray-600">
              ...
              <Link href="/terms">
                <span className="text-orange-600 hover:text-orange-700 cursor-pointer underline">Terms of Service</span>
              </Link>
              {' '}and{' '}
              <Link href="/privacy">
                <span className="text-orange-600 hover:text-orange-700 cursor-pointer underline">Privacy Policy</span>
              </Link>
            </p>
        ...
        <div className="hidden lg:flex flex-1 bg-gradient-to-br from-orange-500 via-red-500 to-purple-600 p-12 items-center justify-center relative overflow-hidden">
          ...
          <div className="relative z-10 text-white max-w-lg">
            <h2 className="text-5xl font-bold mb-6">
              Join 100,000+ Job Seekers
            </h2>
            <p className="text-xl mb-8 text-white/90">
              Get hired faster with AI that does the heavy lifting. Your personal job search assistant is ready.
            </p>
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg">Free forever starter plan</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 bg-white/20 rounded-full flex items-center justify-center backdrop-blur-sm">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-lg">Start applying in 2 minutes</span>
              </div>
            </div>
          </div>
        </div>
